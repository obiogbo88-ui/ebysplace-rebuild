...
export default function Admin() {
  ...
  const sendAnnouncement = trpc.admin.sendAnnouncement.useMutation({
    onSuccess: (result) => {
      ...
      if (result.whatsapp) parts.push(`WhatsApp: ${result.whatsapp.deliveredCount}/${result.whatsapp.recipientCount}`);
    ...
    <DashboardLayout>
      <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="mt-8 grid gap-6">
          ...
          <AdminPanel id="announcements" eyebrow="Multi-channel" title="Send an announcement" description="Send the same message across web push, email, SMS, and WhatsApp, to either your opt-in subscribers or every client who has booked or ordered." icon={Bell} open={isPanelOpen("announcements")} onToggle={() => togglePanel("announcements")}>
            <div className="mt-5">
