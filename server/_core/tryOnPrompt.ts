export function buildTryOnPrompt(styleName: string): string {
  return [
    ...
    "",
    "PRESERVE THE ORIGINAL PHOTO: keep the original camera angle, framing, body position, proportions, clothing, background, and lighting/shadows exactly as they are. Do not generate a new photograph — only edit the hair region of this one.",
    "",
