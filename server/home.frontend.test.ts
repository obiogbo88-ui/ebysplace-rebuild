...
describe("Eby’s Place landing page visual refinements", () => {
  ...
  it("uses the supplied stretched top logo and a reduced, aligned footer logo", () => {
    ...
    expect(homeSource).toContain('<div className="block">');
      expect(homeSource).toContain("btn-gold whitespace-nowrap px-2 py-1.5 text-[0.62rem] uppercase tracking-[.12em] sm:px-4 sm:py-2.5 sm:text-sm");
